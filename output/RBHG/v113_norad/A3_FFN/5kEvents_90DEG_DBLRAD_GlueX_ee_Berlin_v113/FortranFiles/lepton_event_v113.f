...
c
	...
	character(len=200) :: genDir2, cobremsDir, cobremsGlueX, cobremsCPP, cobremsGlueX_var, cobremsCPP_var
...
c*******************************************************************
	subroutine select_cobrems_files(GlueX, cobrems_varbin, 
     &    cobremsGlueX, cobremsCPP, cobremsGlueX_var, cobremsCPP_var, cobremsDir)
	implicit none
	logical GlueX, cobrems_varbin
	character*200 cobremsGlueX, cobremsCPP, cobremsGlueX_var, cobremsCPP_var
	character*200 cobremsDir, override_file
	...
	if (len_trim(override_file) > 0 .and. 
     ...
     &      trim(override_file) /= '#') then
		! User specified custom file (already in cobremsDir)
		! Prepend cobremsDir to the filename
		cobremsGlueX = trim(cobremsDir) // trim(override_file)
		cobremsCPP = trim(cobremsDir) // trim(override_file)
		cobremsGlueX_var = trim(cobremsDir) // trim(override_file)
		cobremsCPP_var = trim(cobremsDir) // trim(override_file)
